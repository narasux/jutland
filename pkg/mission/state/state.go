...
func NewMissionState(mission string) *MissionState {
	...
	return &MissionState{
		...
		Planes:                    map[string]*obj.Plane{
			...
			//"1": obj.NewPlane("F4F-3", obj.NewMapPos(4, 4), 90, "0", faction.HumanAlpha),
			//"2": obj.NewPlane("SBD-3", obj.NewMapPos(5, 5), 180, "0", faction.HumanAlpha),
			//"3": obj.NewPlane("TBD-1", obj.NewMapPos(6, 6), 270, "0", faction.HumanAlpha),
			//"4": obj.NewPlane("A6M_0", obj.NewMapPos(7, 7), 45, "0", faction.HumanAlpha),
			//"5": obj.NewPlane("D3A_99", obj.NewMapPos(8, 8), 135, "0", faction.HumanAlpha),
			//"6": obj.NewPlane("B5N2_97", obj.NewMapPos(9, 9), 225, "0", faction.HumanAlpha),
		},
		GameMarks: map[obj.MarkID]*obj.Mark{},
	}
}
